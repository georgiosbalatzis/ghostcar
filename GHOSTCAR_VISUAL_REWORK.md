...
The `dist/index.html` change is generated by the requested production build. No deployment was performed.
...
| View | Screenshot |
| --- | --- |
| F1Stories light reference | `artifacts/visual-rework/reference-light.png` |
| F1Stories dark reference | `artifacts/visual-rework/reference-dark.png` |
| F1Stories mobile reference | `artifacts/visual-rework/reference-mobile-dark.png` |
| Original production app | `artifacts/visual-rework/production-before.png` |
| Mobile 390px empty, dark | `artifacts/visual-rework/mobile-empty-dark.png` |
| Mobile 390px configured | `artifacts/visual-rework/mobile-configured-dark.png` |
| Mobile 390px 2D, dark | `artifacts/visual-rework/mobile-replay-dark.png` |
| Mobile 390px 2D, light | `artifacts/visual-rework/mobile-replay-light.png` |
| Mobile 390px 3D | `artifacts/visual-rework/mobile-3d-dark.png` |
| Mobile playback running | `artifacts/visual-rework/mobile-playback-running.png` |
| Mobile telemetry | `artifacts/visual-rework/mobile-telemetry-light.png` |
| Mobile featured comparisons | `artifacts/visual-rework/mobile-presets-dark.png` |
| Manual alternate laps | `artifacts/visual-rework/mobile-alternate-laps-dark.png` |
| Mobile 360px | `artifacts/visual-rework/mobile-360-dark.png` |
| Mobile 320px | `artifacts/visual-rework/mobile-320-dark.png` |
| Tablet 768px, dark | `artifacts/visual-rework/tablet-replay-dark.png` |
| Tablet 768px, light | `artifacts/visual-rework/tablet-replay-light.png` |
| Tablet H2H, partial live scan | `artifacts/visual-rework/tablet-h2h-light.png` |
| Desktop 1440px 2D, dark | `artifacts/visual-rework/desktop-2d-dark.png` |
| Desktop 1440px 2D, light | `artifacts/visual-rework/desktop-2d-light.png` |
| Desktop 1440px 3D, dark | `artifacts/visual-rework/desktop-3d-dark.png` |
| Desktop 1440px 3D, light | `artifacts/visual-rework/desktop-3d-light.png` |
| Desktop gallery | `artifacts/visual-rework/desktop-gallery-dark.png` |
| Desktop season, available live results | `artifacts/visual-rework/desktop-season-light.png` |
