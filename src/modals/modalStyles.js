...
export function getModalSurfaceStyle(
  ...
  return {
    ...
    position: "fixed",
    top: mob ? "auto" : "50%",
    bottom: mob ? "env(safe-area-inset-bottom, 0px)" : undefined,
    left: "50%",
    transform: mob ? "translateX(-50%)" : "translate(-50%,-50%)",
    zIndex: 100,
    width: mob ? mobileWidth : width,
    maxWidth: maxWidth || "calc(100vw - 24px)",
    maxHeight: mob ? "88dvh" : maxHeight,
